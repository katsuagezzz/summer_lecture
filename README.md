...
| 回 | 講義日 | テーマ | ファイル |
|---|---|---|---|
| 夏期 第7回 | 2026-09-22 | 米国債は「売られすぎ」で危ないのか／信用買い ── 手元30万円で100万円分を買うと、何が起きるか（**第1部** Xの投稿の検算・図1の矢印①〜⑤・日本が売る3つの入口・9/16 FOMC と 9/18 日銀の答え合わせ欄／**第2部** 信用買いの三者・追証と強制決済・現金の出入り・差金決済／現引き／信用倍率の使い方。図10枚） | [HTML](lectures/lecture_20260922.html) ・ [Pages](https://katsuagezzz.github.io/summer_lecture/lectures/lecture_20260922.html) |

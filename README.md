...
| 回 | 講義日 | テーマ | ファイル |
|---|---|---|---|
| 夏期 第8回 | 2026-09-22 | 日米政策金利推移（2006年から2026年）と、利上げ後の株・金利・為替（**9/16 FOMC 3.75〜4.00%へ・9/18 日銀 1.25%程度へ、どちらも0.25ポイントの引き上げ**。§1 20年の政策金利と日米の差〈図1・図2〉と2026年の会合日程／§2 FOMCの決定と、当日から翌々日までの米3指数の日次騰落率〈図3〉／§3 日銀の決定と、日経平均・TOPIX・日本10年債・ドル円。報道ベースを一次情報で置き換える記入欄つき／§4 向きが教科書と違った4点＝**差は2.75ポイントのまま動いていない**／利上げの日に円安／利上げ当日の符号が日米で逆／日経平均とTOPIXの符号が割れた。問1〜問5。あわせて**9/15で答えが出なかった15問**、**§5 オプション取引**〈権利行使価格・期日・プレミアム。日経225オプション、取引の流れ4段、コールの満期損益〈図4〉、買い手＝権利／売り手＝義務のカード2枚、用語4つ、問6〜問8〉、**後半にチーム別ポートフォリオ**〈TradingViewの3リンク・チーム課題は「組み替える条件を1行」〉、宿題1行） | [HTML](lectures/lecture_20260922.html) ・ [Pages](https://katsuagezzz.github.io/summer_lecture/lectures/lecture_20260922.html) |

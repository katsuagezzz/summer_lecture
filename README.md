...
| 回 | 講義日 | テーマ | ファイル |
|---|---|---|---|
| 第7回 | 2026-09-10 | 先に売って、あとで買い戻す ― 明日の介入、年末の下げ、Jトラストの優待クロス | [HTML](lectures/lecture_sasaki_20260910.html) ・ [Pages](https://katsuagezzz.github.io/summer_lecture/lectures/lecture_sasaki_20260910.html) |

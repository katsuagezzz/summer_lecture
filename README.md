...
| 講義日 | テーマ | ファイル |
|---|---|---|
| 2026-09-11 | 「ロボットが全部つくるなら、お金は要らない」― では、要らなくならないものは何か（エコノミスト誌のマスク・インタビュー。お金とは何の引換券か。答えなし） | [HTML](lectures/lecture_toyonaga_20260911.html) ・ [Pages](https://katsuagezzz.github.io/summer_lecture/lectures/lecture_toyonaga_20260911.html) |
